...
%type <node> Statement StatRep Expr Args CommaExpr ExprAux
...
StatRep:	Statement StatRep		{ $$ = insertStatRepetition($1, $2); }
		|							{ $$ = NULL;  }
		;
...
int main(int argc, char **argv)
{
	...
	if(yyparse() == 0)
	{
        ...
        generate_code(myProgram, mySemantic);
    }
